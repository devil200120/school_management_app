import React, { createContext, forwardRef, useContext, useEffect, useState, useCallback, useMemo } from "react";
...
const SidebarProvider = forwardRef(({ defaultOpen = true, open: openProp, onOpenChange, className, style, children, ...props }, ref) => {
