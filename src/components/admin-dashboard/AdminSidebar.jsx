    ...
    <div className="sidebar">
      <ul>
        ...
        <li>
          <Button
            className={`w-100 ${
              activeTab === 6 && isToggleSubmenu ? "active" : ""
            }  ${
              location.pathname === `${routes.addCoupon}` ||
              location.pathname === `${routes.manageCoupon}`
                ? "current-active"
                : ""
            } `}
          ...
          <div
            className={`submenuWrapper ${
              activeTab === 6 && isToggleSubmenu ? "colapse" : "collapsed"
            }`}
          >
            <ul className="submenu">
              <li>
                <Link
                  to={routes.addCoupon}
                  className={`${
                    location.pathname === `${routes.addCoupon}` ? "active" : ""
                  }`}
                >
                  Add Coupon
                </Link>
        ...
        <li>
          <Button
            className={`w-100 ${
              activeTab === 7 && isToggleSubmenu ? "active" : ""
            }  ${
            ...
            onClick={() => handleMenuClick(7, true)}
          >
            <span className="icon">
              <BiMessageDetail />
            </span>
          ...
          <div
            className={`submenuWrapper ${
              activeTab === 7 && isToggleSubmenu ? "colapse" : "collapsed"
            }`}
          >
            <ul className="submenu">
              <li>
        ...
        <li>
          <Button
            className={`w-100 ${
              activeTab === 8 && isToggleSubmenu ? "active" : ""
            }  ${
            ...
            onClick={() => handleMenuClick(8, true)}
          >
            <span className="icon">
              <FaBlog />
            </span>
          ...
          <div
            className={`submenuWrapper ${
              activeTab === 8 && isToggleSubmenu ? "colapse" : "collapsed"
            }`}
          >
            <ul className="submenu">
              <li>
