 ...
 * Professional compact design with clean tables and proper layout
 * Green border theme with organized tabular structure
 */
    ...
    <div className="w-full bg-white relative flex flex-col border-8 border-green-600" style={{ padding: 0 }}>
      ...
      <div className="mx-4 mb-4 border-2 border-blue-500 overflow-hidden">
        ...
        <table className="w-full text-xs" style={{ borderCollapse: 'collapse' }}>
          <thead>
            <tr className="border-b-2 border-blue-500">
              <th rowSpan="2" className="border-r-2 border-blue-500 p-1 font-bold bg-white text-left">SUBJECT</th>
              ...
              <th colSpan="2" className="border-r-2 border-b border-blue-500 p-1 font-bold bg-blue-50">Class Stat</th>
            ...
            <tr className="border-b-2 border-blue-500 text-[9px]">
              <th className="border-r border-blue-500 p-1 bg-white h-12 text-center" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>Obtainable</th>
              <th className="border-r border-blue-500 p-1 bg-white">(20%)</th>
              <th className="border-r border-blue-500 p-1 bg-white h-12 text-center" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>Obtained</th>
              <th className="border-r-2 border-blue-500 p-1 bg-white text-center">Mark</th>
              ...
              <th className="border-r border-blue-500 p-1 bg-white h-12 text-center" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>Highest</th>
              <th className="border-r-2 border-blue-500 p-1 bg-white h-12 text-center" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>Lowest</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-blue-500">
              <td className="border-r-2 border-blue-500 p-1 font-semibold bg-white">Mathematics</td>
              ...
              <td className="border-r border-blue-500 p-1 text-center">50</td>
              <td className="border-r border-blue-500 p-1 text-center">40</td>
              <td className="border-r border-blue-500 p-1 text-center">75</td>
              <td className="border-r-2 border-blue-500 p-1 text-center">60</td>

              <td className="border-r border-blue-500 p-1 text-center font-bold">76</td>
              <td className="border-r-2 border-blue-500 p-1 text-center font-bold">76</td>

              <td className="border-r border-blue-500 p-1 text-center">80</td>
              <td className="border-r-2 border-blue-500 p-1 text-center">60</td>

              <td className="p-1 text-center">Very Good</td>
            </tr>
            <tr className="border-b-2 border-blue-500">
              <td className="border-r-2 border-blue-500 p-1 font-semibold bg-white">English Language</td>
              <td className="border-r border-blue-500 p-1 text-center">20</td>
              <td className="border-r border-blue-500 p-1 text-center">15</td>
              <td className="border-r border-blue-500 p-1 text-center">10</td>
              <td className="border-r-2 border-blue-500 p-1 text-center">12</td>
            ...
            <tr className="bg-blue-50 font-semibold border-b-2 border-blue-500 text-xs">
              <td className="border-r-2 border-blue-500 p-1">Total Offered: 2</td>
              <td colSpan="4" className="border-r-2 border-blue-500 p-1">Total Pass: 2</td>
              <td colSpan="4" className="border-r-2 border-blue-500 p-1">Net Score: 152/200</td>
              <td colSpan="4" className="border-r-2 border-blue-500 p-1">Class Position: A</td>
              <td colSpan="4" className="border-r-2 border-blue-500 p-1">Average: 76%</td>
              <td className="p-1"></td>
            </tr>
          </tbody>
        </table>
