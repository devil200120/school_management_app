...
import { Mycontext } from "../../layouts/AdminDashboardLayout";
...
const AdminHeader = () => {
	...
	// console.log("Window Width:", context.windowWidth);
						...
						<div className="myAccWrapper">
							...
							>
								...
								<div className="userInfo res-hide">
									<h4>Giwa Abdulbasit</h4>
									<p className="mb-0">@giwamii</p>
								</div>
							</Button>
							<Menu
								anchorEl={anchorEl}
							...
							>
								<MenuItem
									onClick={() => {
										...
										navigate(routes.adminMyAccount);
									}}
								>
									<ListItemIcon>
								...
								<MenuItem
									onClick={() => {
										handleCloseMyAccDrop();
										navigate(routes.adminResetPassword);
									}}
								>
									<ListItemIcon>
										<IoShieldHalfOutline />
