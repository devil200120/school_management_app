...
export const adminMenuItems = [
  ...
  },
  {
    ...
    icon: BarChart,
    submenu: [
      { title: 'Dashboard Analytics', path: '/admin/analytics/dashboard-analytics' }
    ]
  },
  {
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: 'Assessment Management', path: '/admin/exam/assessment-management' }
    ]
  },
  {
  ...
  },
  {
    ...
    icon: FileText,
    submenu: [
      { title: 'Result Card Settings', path: '/admin/result/result-card-settings' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: 'Medical Equipment', path: '/admin/inventory/medical-equipment' },
