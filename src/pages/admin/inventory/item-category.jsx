...
const categories = [
  { id: 1, name: 'Electronics', description: 'All electronic devices and components' },
  { id: 2, name: 'Books', description: 'Textbooks and other reading materials' },
  { id: 3, name: 'Sports', description: 'Sports equipment and gear' },
  { id: 4, name: 'Furniture', description: 'Chairs, desks, and other furniture items' },
