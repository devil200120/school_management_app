  ...
  const plans = [
    ...
    },
    {
      ...
      features: {
        ...
        teacher: [
          "All Silver Features (Time-Table Management, Assessment Management, Basic Attendance)",
          "Exam Management",
        ...
        admin: [
          "All Silver Features (Time-Table, Library, Assessment, Payment Management, Basic Attendance)",
          "Analytics Dashboard",
        ...
        accountant: [
          "All Silver Features (Payment Processing, Payment Management, Fee Collection, Reports)",
        ],
        mobile: false,
        exclusive: [
    ...
    },
    {
      ...
      features: {
        ...
        admin: [
          "All Gold Features (Analytics, Attendance Management, Exam Management, Teacher Comments, Inventory, Lesson Plan, QR-based Attendance)",
          "User Management",
          "Quiz Management",
        ...
        accountant: [
          "All Gold/Silver Features (Payment Processing, Payment Management, Fee Collection, Reports, Balance Sheets, Revenue Analysis)",
          "Expenses Management",
          "Salary Management",
