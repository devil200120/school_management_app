...
const TeacherAttendancePanel = () => {
  ...
  const [duplicateScanPrevention, setDuplicateScanPrevention] = useState(new Set());
  ...
  const markAttendance = (studentId, status, method = attendanceMethod, additionalData = {}) => {
    ...
    if (duplicateScanPrevention.has(recentScanKey)) {
      setScannedData(`⚠️ Duplicate scan detected for ${student?.name}. Please wait before scanning again.`);
  ...
  const handleNFCScanned = (nfcData, additionalData = {}) => {
    ...
    if (success) {
      ...
      setTimeout(() => {
        setScannedData(`🎯 Signal: ${additionalData.signalStrength || 85}% | Read time: ${additionalData.readTime || 150}ms`);
        setTimeout(() => setScannedData(""), 3000);
      }, 2000);
    }
  ...
  const handleQRScanned = (qrData, additionalData = {}) => {
    ...
    if (success) {
      ...
      setTimeout(() => {
        setScannedData(`📊 Quality: ${additionalData.quality || 85}% | Distance: ${additionalData.distance || 35}cm`);
        setTimeout(() => setScannedData(""), 3000);
      }, 2000);
    }
  ...
  const handleFaceRecognized = (faceId, additionalData = {}) => {
    ...
    if (additionalData.confidence < 75) {
      setScannedData(`⚠️ Low confidence (${additionalData.confidence.toFixed(1)}%) - Please try again`);
      setTimeout(() => setScannedData(""), 4000);
      setFaceRecognitionActive(false);
      return;
    }
    ...
    if (success) {
      ...
      setTimeout(() => {
        setScannedData(`🎯 Confidence: ${additionalData.confidence.toFixed(1)}% | Angle: ${additionalData.faceAngle || 0}°`);
        setTimeout(() => setScannedData(""), 3000);
      }, 2000);
    }
                ...
                {attendanceMethod === "nfc" && (
                  <Card className="p-6">
                    <h3 className="text-lg font-semibold mb-4 flex items-center space-x-2">
                      ...
                      <Badge variant={nfcConnectionStatus === "connected" ? "default" : "secondary"} className="ml-2">
                        {nfcConnectionStatus === "connected" ? "🟢 Connected" : 
                         nfcConnectionStatus === "connecting" ? "🟡 Connecting..." : 
                         nfcConnectionStatus === "error" ? "🔴 Error" : "⚫ Disconnected"}
                      </Badge>
                    </h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Reader Control</h4>
                        <div className={`p-6 border-2 border-dashed rounded-lg text-center ${
                          nfcReaderActive ? 'border-blue-500 bg-blue-50' : 'border-gray-300'
                        }`}>
                          {nfcReaderActive ? (
                            <div className="space-y-3">
                              ...
                              <p className="text-blue-600 font-medium">📡 NFC Reader Active</p>
                              <p className="text-sm text-gray-600">Tap your student ID card on the reader</p>
                              <div className="mt-3 p-2 bg-blue-100 rounded">
                                <p className="text-xs text-blue-800">🔍 Scanning for NFC signals...</p>
                                <p className="text-xs text-blue-600 mt-1">Range: 4cm | Frequency: 13.56 MHz</p>
                              </div>
                              <Button 
                            ...
                            <div className="space-y-3">
                              ...
                              <p className="text-gray-600">NFC Reader Inactive</p>
                              <p className="text-sm text-gray-500">Click to start scanning for student cards</p>
                              <div className="mt-3 p-2 bg-gray-100 rounded">
                                <p className="text-xs text-gray-600">Status: {nfcConnectionStatus}</p>
                                {lastScanAttempt && (
                                  <p className="text-xs text-gray-500 mt-1">
                                    Last scan: {lastScanAttempt.timestamp.toLocaleTimeString()}
                                  </p>
                                )}
                              </div>
                              <Button 
                                ...
                                className="mt-2"
                              >
                                {nfcConnectionStatus === "disconnected" ? "🔗 Connect & Start" : "▶️ Start NFC Reader"}
                              </Button>
                            </div>
                          )}
                        </div>
                        ...
                        {scannedData && (
                          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <p className="text-blue-800 text-sm font-medium">{scannedData}</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Student Cards ({students.length})</h4>
                          ...
                          {students.map((student) => (
                            <div key={student.id} className="border rounded-lg p-3 bg-gray-50">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <Badge variant={student.cardStatus === 'active' ? 'default' : 'destructive'}>
                                  {student.cardStatus === 'active' ? '🟢 Active' : '🔴 Blocked'}
                                </Badge>
                              </div>
                              
                              <div className="space-y-1 text-xs text-gray-600">
                                <p>🆔 NFC: {student.nfcId}</p>
                                <p>💳 Card: ****{student.cardNumber.slice(-4)}</p>
                                <p>📊 Streak: {student.attendanceStreak} days</p>
                              </div>
                              ...
                              <div className="mt-2 flex space-x-2">
                                <Button 
                                  size="sm" 
                                  variant="outline" 
                                  onClick={() => handleNFCScanned(student.nfcId, {
                                    cardNumber: student.cardNumber,
                                    signalStrength: 95,
                                    readTime: 120
                                  })}
                      ...
                      <div className="space-y-3">
                        <h4 className="font-medium text-gray-700">NFC Activity Log</h4>
                        <div className="space-y-2 max-h-96 overflow-y-auto">
                          {attendanceLog.length === 0 ? (
                            <p className="text-gray-500 text-sm">No NFC activity yet</p>
                          ) : (
                            attendanceLog
                              ...
                              .map(log => (
                                <div key={log.id} className={`p-3 rounded border ${
                                  ...
                                  log.status === 'failed' ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'
                                }`}>
                                  <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                      <span className="text-sm font-medium">{log.studentName}</span>
                                      {log.rollNo && <span className="text-xs text-gray-500 ml-2">#{log.rollNo}</span>}
                                      <p className="text-xs mt-1 flex items-center space-x-1">
                                        <span>{log.status === 'present' ? '✅' : '❌'}</span>
                                        <span>{log.status}</span>
                                        {log.confidence && <span>• {log.confidence}%</span>}
                                      </p>
                                      {log.additionalData && (
                                        <p className="text-xs text-gray-500 mt-1">
                                          {log.additionalData.signalStrength && `📶 ${log.additionalData.signalStrength}% • `}
                                          {log.additionalData.readTime && `⚡ ${log.additionalData.readTime}ms`}
                                        </p>
                                      )}
                                      {log.error && (
                                        <p className="text-xs text-red-600 mt-1">⚠️ {log.error}</p>
                                      )}
                                    </div>
                                    <div className="text-right">
                                      ...
                                      <div className="flex items-center space-x-1 mt-1">
                                        ...
                                        <span className="text-xs text-blue-600">NFC</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                ...
                {attendanceMethod === "qrcode" && (
                  <Card className="p-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      {/* Scanner Interface */}
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Camera Scanner</h4>
                        <div className={`p-6 border-2 border-dashed rounded-lg text-center ${
                          qrScannerActive ? 'border-purple-500 bg-purple-50' : 'border-gray-300'
                        }`}>
                          {qrScannerActive ? (
                            <div className="space-y-3">
                              <div className="animate-pulse">
                              ...
                              <p className="text-purple-600 font-medium">Camera Active</p>
                              <p className="text-sm text-gray-600">Position QR code in view</p>
                            ...
                            <div className="space-y-3">
                              ...
                              <p className="text-gray-600">QR Scanner Inactive</p>
                              <Button 
                        ...
                        {scannedData && (
                          <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-green-800 text-sm font-medium">{scannedData}</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Student QR Codes</h4>
                        <div className="space-y-3 max-h-96 overflow-y-auto">
                          {students.map((student) => (
                            <div key={student.id} className="border rounded-lg p-3 bg-gray-50">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <div className="text-right">
                                  <p className="text-xs text-purple-600 font-medium">QR: {student.qrCode}</p>
                                </div>
                              </div>
                              {/* QR Code Display */}
                                  ...
                                  <div className="grid grid-cols-8 gap-0.5 w-16 h-16">
                                    ...
                                    {Array.from({ length: 64 }, (_, i) => (
                                      <div
                                        key={i}
                                        className={`w-1 h-1 ${
                                          (i + student.qrCode.charCodeAt(i % student.qrCode.length)) % 2 === 0
                                            ? 'bg-black'
                                            : 'bg-white'
                                        }`}
                                      />
                              ...
                              <div className="mt-2 flex justify-center">
                                <Button 
                                  size="sm" 
                                  variant="outline" 
                                  onClick={() => handleQRScanned(student.qrCode)}
                                  className="text-xs"
                                >
                                  Simulate Scan
                                </Button>
                      ...
                      {/* Recent Scans */}
                      <div className="space-y-3">
                        <h4 className="font-medium text-gray-700">Recent QR Scans</h4>
                        <div className="space-y-2 max-h-96 overflow-y-auto">
                          {attendanceLog.length === 0 ? (
                            ...
                            attendanceLog
                              ...
                              .reverse()
                              .map(log => (
                                <div key={log.id} className="flex items-center justify-between p-3 bg-purple-50 border border-purple-200 rounded">
                                  <div>
                                    <span className="text-sm font-medium">{log.studentName}</span>
                                  ...
                                  <div className="text-right">
                                    ...
                                    <div className="flex items-center space-x-1 mt-1">
                                      ...
                                      <span className="text-xs text-purple-600">QR Scan</span>
                                    </div>
                                  </div>
                                </div>
                              ))
                ...
                {attendanceMethod === "face" && (
                  <Card className="p-6">
                    <h3 className="text-lg font-semibold mb-4 flex items-center space-x-2">
                      ...
                      <Badge variant={cameraStream ? "default" : "secondary"} className="ml-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Live Face Detection</h4>
                        <div className={`p-6 border-2 border-dashed rounded-lg text-center ${
                          faceRecognitionActive ? 'border-green-500 bg-green-50' : 'border-gray-300'
                        }`}>
                          {faceRecognitionActive ? (
                            <div className="space-y-3">
                              ...
                              <p className="text-green-600 font-medium">🎥 Face Recognition Active</p>
                                ...
                                <div className="w-24 h-30 border-2 border-green-500 rounded-lg flex items-center justify-center relative">
                                  ...
                                  <div className="absolute -bottom-8 left-0 right-0">
                                    <div className="text-xs text-green-700 font-medium mb-1">
                                      Confidence: {faceDetectionConfidence.toFixed(1)}%
                                    </div>
                              ...
                              <div className="mt-4 p-2 bg-green-100 rounded text-xs">
                                <p className="text-green-800">🧠 AI Processing...</p>
                                <p className="text-green-600">Resolution: 1920x1080 | FPS: 30</p>
                                <p className="text-green-600">Lighting: Good | Angle: Optimal</p>
                              </div>
                            ...
                            <div className="space-y-3">
                              ...
                              <p className="text-gray-600">Face Recognition Inactive</p>
                              <p className="text-sm text-gray-500">AI-powered facial recognition system</p>
                              
                              <div className="mt-3 p-3 bg-gray-100 rounded">
                                <p className="text-xs text-gray-600 font-medium">System Status:</p>
                                <p className="text-xs text-gray-500">
                                  Camera: {cameraStream ? "✅ Ready" : "❌ Not initialized"}
                                </p>
                                <p className="text-xs text-gray-500">
                                  AI Models: {cameraStream === "face-detection-stream" ? "✅ Loaded" : "❌ Not loaded"}
                                </p>
                                <p className="text-xs text-gray-500">
                              ...
                              <Button 
                                ...
                                className="mt-2"
                              >
                                {cameraStream !== "face-detection-stream" ? "🔗 Initialize System" : "▶️ Start Face Recognition"}
                              </Button>
                            </div>
                          )}
                        </div>
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-700">Enrolled Faces ({students.length})</h4>
                        <div className="space-y-3 max-h-96 overflow-y-auto">
                          {students.map((student) => (
                            <div key={student.id} className="border rounded-lg p-3 bg-gray-50">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                  <p className="font-medium text-sm">{student.name}</p>
                                  <p className="text-xs text-gray-500">Roll: {student.rollNo}</p>
                                  <p className="text-xs text-purple-600">Face ID: {student.faceId}</p>
                                </div>
                              </div>
                              ...
                              <div className="mt-3 flex space-x-2">
                                <Button 
                                  size="sm" 
                                  variant="outline" 
                                  onClick={() => handleFaceRecognized(student.faceId, {
                                    confidence: 92.5,
                                    facePosition: { x: 150, y: 120, width: 150, height: 180 },
                                    lightingCondition: 'good',
                                    faceAngle: 2
                                  })}
                                  className="text-xs flex-1"
                      ...
                      <div className="space-y-3">
                        <h4 className="font-medium text-gray-700">Recognition Activity</h4>
                        <div className="space-y-2 max-h-96 overflow-y-auto">
                          {attendanceLog.length === 0 ? (
                            <p className="text-gray-500 text-sm">No face recognition activity yet</p>
                          ) : (
                            attendanceLog
                                  ...
                                  <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                      <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-sm font-medium">{log.studentName}</span>
                                        {log.rollNo && <span className="text-xs text-gray-500">#{log.rollNo}</span>}
                                      </div>
                                      
                                      <p className="text-xs mt-1 flex items-center space-x-1">
                                        <span>{log.status === 'present' ? '✅' : '❌'}</span>
                                        <span>{log.status}</span>
                                        {log.confidence && <span>• {log.confidence.toFixed(1)}%</span>}
                                      </p>
                                      
                                      {log.additionalData && (
                                        <p className="text-xs text-gray-500 mt-1">
                                          {log.additionalData.faceAngle !== undefined && `📐 ${log.additionalData.faceAngle}° • `}
                                          {log.additionalData.lightingCondition && `💡 ${log.additionalData.lightingCondition}`}
                                        </p>
                                      )}
                                    ...
                                    <div className="text-right">
                                      ...
                                      <div className="flex items-center space-x-1 mt-1">
                                        ...
                                        <span className="text-xs text-green-600">Face AI</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
              ...
              <Card className="p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="text-sm font-medium text-blue-900 mb-1">Selected Date</p>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <Badge variant="default" className="text-xs">Present: 28/30</Badge>
                    </div>
                    <Progress value={93.3} className="h-2" />
                    <p className="text-xs text-gray-600 mt-1">Period 1-2 • 93.3% attendance</p>
                  </div>
                  
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium text-gray-700">Class 10B</span>
                      <Badge variant="default" className="text-xs">Present: 25/28</Badge>
                    </div>
                    <Progress value={89.3} className="h-2" />
                    <p className="text-xs text-gray-600 mt-1">Period 3-4 • 89.3% attendance</p>
                  </div>
                  
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium text-gray-700">Class 11A</span>
                      <Badge variant="secondary" className="text-xs">Present: 22/26</Badge>
                    </div>
                    <Progress value={84.6} className="h-2" />
                    <p className="text-xs text-gray-600 mt-1">Period 5-6 • 84.6% attendance</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                    ...
                    <span className="text-lg font-bold text-green-900">87.2%</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    ...
                    <span className="text-lg font-bold text-purple-900">38.5h</span>
                  </div>
                  
                  <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-orange-900">Punctuality</p>
                      <p className="text-xs text-orange-700">On-time rate</p>
                    </div>
                    <span className="text-lg font-bold text-orange-900">95%</span>
                  </div>
                </div>
              </Card>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm font-medium">High Attendance (&gt;90%)</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm font-medium">Average Attendance (75-90%)</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm font-medium">Low Attendance (&lt;75%)</span>
                    </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm font-medium text-blue-800">Parent meeting</span>
                    </div>
                  ...
                  <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm font-medium text-green-800">Good performance</span>
                    </div>
