...
const VerifyOtp = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      const response = await fetch("https://api.eduos.com.ng/api/verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ email, verification_code: enteredOtp }), // Ensure correct field name
      });
      ...
      if (!response.ok) {
        ...
        // Redirect to subscription plans page instead of dashboard
