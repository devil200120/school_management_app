              ...
              <TableBody>
                {filteredAssessments.length === 0 ? (
                  <TableRow>
                    ...
                    >
                      No assessments found. Create a new assessment to get
                      started.
                    </TableCell>
                  </TableRow>
                ) : (
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold">
                  {getSelectedAssessment()?.title}
                </h3>
                <Badge
                  variant="outline"
                  className={
                    getSelectedAssessment()?.status === "active"
                      ? "bg-green-100 text-green-800 mt-2"
                      : getSelectedAssessment()?.status === "upcoming"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p>
                      {getSelectedAssessment()?.class}{" "}
                      {getSelectedAssessment()?.section}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-medium">
                      {getSelectedAssessment()?.totalStudents}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Submitted</p>
                    <p className="text-lg font-medium">
                      {getSelectedAssessment()?.submitted}
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    defaultValue={getSelectedAssessment()?.title}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    defaultValue={getSelectedAssessment()?.subject}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    defaultValue={getSelectedAssessment()?.class}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    type="date"
                    defaultValue={getSelectedAssessment()?.date}
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Duration *</label>
                  <Input
                    defaultValue={getSelectedAssessment()?.duration}
                    placeholder="Enter duration"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Status *</label>
                  <Select defaultValue={getSelectedAssessment()?.status}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
