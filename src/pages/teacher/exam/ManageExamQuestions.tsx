...
const questionBank = [
  ...
  },
  {
    ...
    topic: 'Calculus',
    difficulty: 'Medium',
    options: ['f\'(x) = 6x + 2', 'f\'(x) = 3x + 2', 'f\'(x) = 6x - 5', 'f\'(x) = 6x² + 2'],
    correctAnswer: 0,
...
const ManageExamQuestions: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                  ...
                  <ul className="list-disc list-inside text-sm text-yellow-700 space-y-1">
                    ...
                    <li>Fill in your questions following the specified format</li>
                    <li>Save the file and upload it here</li>
                    <li>For multiple-choice questions, separate options with a semicolon (;)</li>
                    <li>Specify the correct answer by its index (starting from 0)</li>
                  </ul>
                </div>
      ...
      <Dialog open={isViewQuestionDialogOpen} onOpenChange={setIsViewQuestionDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
          ...
          {selectedQuestion && (
            <div className="space-y-4">
              <div>
                ...
                <p className="p-3 bg-gray-50 border rounded-md mt-1">{selectedQuestion.question}</p>
              </div>
              ...
              <div>
                ...
                <p>{new Date(selectedQuestion.createdAt).toLocaleDateString('en-US', { 
                  year: 'numeric', 
                  month: 'long', 
                  day: 'numeric' 
                })}</p>
