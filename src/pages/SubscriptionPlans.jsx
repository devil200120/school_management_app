  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Teacher Panel (Web): Adds Time-Table and Assessment management",
        "Accountant Panel (Web): Payments, Fee Collection, Reports (Collection, Balance Sheets, Revenue Analysis)",
        "Admin Panel (Web): Adds Manage Time-Table, School Library, Manage Assessment",
    ...
    },
    {
      ...
      popular: true,
      features: [
        "All Silver and Bronze features included",
        ...
        "Admin Panel (Web): Adds Analytics, Teacher/Student Attendance management",
    ...
    },
    {
      ...
      popular: false,
      features: [
        "All Gold, Silver, and Bronze features included",
        ...
        "Report Card Insights, E-Learning management, advanced NFC & Face Recognition Attendance",
