...
import StatsSection from "../../components/main-site/StatsSection";
import OurSerives from "../../components/main-site/OurSerives";
import WhyChooseUs from "../../components/main-site/WhyChooseUs";
      ...
      <div className="top">
        ...
        <section className="home" id="home" data-aos="fade-up">
          <div className="row one">
            <h2>
              Revolutionize School Management with <span>EDUOS</span>
            </h2>
            <p>
              Transform how your school operates with an all-in-one, easy-to-use
              educational portal designed for seamless online education and
              efficient administration.
            </p>
            <p className="smallie">
              Join hundreds of schools already simplifying their management. Try
              EDUOS today!
            </p>
            <button className="hero-button">
              <span className="text">Get A School Website Now</span>
              <span className="svg">
                <svg
          ...
          <div className="row image">
            <img src="/schbg (2).png" alt="hero" />
          </div>
        </section>
      </div>

      <section id="about" className="about-section">
        <div className="row image" data-aos="zoom-in">
          <img src="/download.png" alt="" />
        </div>
        <div className="row context" data-aos="fade-up">
          <h2>About EDUOS</h2>
          <p>
            ...
            Exams, Result Processing and Checking, Burs...
          </p>
          <ReadMoreButton />
        </div>
      </section>
