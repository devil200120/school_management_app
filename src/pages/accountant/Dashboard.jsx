...
const AccountantDashboard = () => {
  ...
  // Reports card insights data
  const reportInsights = [
    {
      title: "Class Performance",
      value: "87.5%",
      change: "+4.2%",
      description: "Average performance across all classes",
  ...
  const handleQuickAction = (actionType) => {
    switch (actionType) {
      case "record-payment":
        toast.success("Navigating to Payment Recording...");
      ...
      case "export-report":
        ...
        break;
      case "view-debtors":
        toast.success("Loading debtors list...");
        // Navigate to debtors page
        break;
      case "record-expense":
        toast.success("Opening expense recording form...");
        // Navigate to expense recording
        break;
      case "view-reports":
        toast.success("Loading all reports...");
        ...
        <Card className="md:w-1/3">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-2 p-0">
              <Button
                variant="outline"
                className="flex items-center gap-1 justify-center h-auto py-2"
              ...
              <Button
                variant="outline"
                className="flex items-center gap-1 justify-center h-auto py-2"
                onClick={() => handleQuickAction("view-debtors")}
              >
      ...
      <motion.div variants={item}>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {dashboardStats.map((stat, index) => (
            ...
            >
              <Card
                className={`overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 bg-gradient-to-br ${stat.bgGradient} border-0`}
              >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reportInsights.map((insight, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${insight.color} opacity-5 group-hover:opacity-10 transition-opacity`}
                ></div>
                <CardContent className="p-6 relative z-10">
                  <div className="flex items-start justify-between">
                    ...
                    <div
                      className={`w-12 h-12 rounded-lg bg-gradient-to-br ${insight.color} flex items-center justify-center`}
                    >
